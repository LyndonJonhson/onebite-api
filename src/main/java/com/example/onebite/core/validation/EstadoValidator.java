...
public class EstadoValidator implements ConstraintValidator<EstadoValid, EstadoResponseDTO> {
	
	@Autowired
	private EstadoRepository repository;
	
	@Override
	public boolean isValid(EstadoResponseDTO dto, ConstraintValidatorContext context) {
